...
Wskaźnik Sharpe'a to informacja o zysku skorygowanym o ryzyko (>1 dobrze, <0 źle).W ciągu ostatnich 9 miesięcy WIG20 miał najniższy wskaźnik Sharpe’a, co świadczy o słabym stosunku zysku do ryzyka. Potwierdza to, że GPW jest najmniej opłacalną z porównywanych giełd